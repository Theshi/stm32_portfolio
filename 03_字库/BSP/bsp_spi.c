...
uint32_t SPI_Flash_ReadID(void)
{
    ...
    /* 发送 JEDEC ID 命令 0x9F */
    SPI_Flash_SendByte(W25X_JedecDeviceID);    /* 【修复】原代码: SPI_FLASH_SendByte */

    /* 连续读取 3 字节 ID */
    Temp0 = SPI_Flash_SendByte(Dummy_Byte);    /* 【修复】原代码: SPI_FLASH_SendByte */
    Temp1 = SPI_Flash_SendByte(Dummy_Byte);    /* 【修复】原代码: SPI_FLASH_SendByte */
    Temp2 = SPI_Flash_SendByte(Dummy_Byte);    /* 【修复】原代码: SPI_FLASH_SendByte */
